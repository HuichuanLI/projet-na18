<?php
    ...
    $sql = "SELECT * FROM public.produit_commande, public.commande, public.annonce WHERE commande.num_commande = produit_commande.num_commande and annonce.ref_produit = produit_commande.ref_produit and annonce.login_vendeur = ?;";
